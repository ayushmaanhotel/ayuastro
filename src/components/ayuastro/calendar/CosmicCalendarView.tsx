        ...
        <div className="max-w-lg mx-auto px-4 py-3">
          <div className="flex items-center justify-between mb-2">
            <Button
              ...
              className="text-brown-400 hover:text-brown-700 dark:text-brown-300 dark:hover:text-brown-100 -ml-2"
            >
          ...
          <div className="flex items-center justify-between">
            <Button
              ...
              className="size-9 text-brown-400 hover:text-brown-700 dark:text-brown-300 dark:hover:text-brown-100 disabled:opacity-30"
            >
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-brown-400 dark:text-brown-400">{currentYear}</p>
            </div>
      ...
      <div className="max-w-lg mx-auto px-4 py-4 space-y-4">
            ...
            <CardContent className="p-5">
              <div className="flex items-start gap-3 mb-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-brown-400 dark:text-brown-400 mt-0.5">
              ...
              {topEvents.length > 0 && (
                <div className="mt-3 space-y-2">
                  <p className="text-[10px] uppercase tracking-wider text-brown-400 dark:text-brown-400 font-medium">
                  ...
                  {topEvents.map((event, i) => (
                    ...
                    >
                      ...
                      <span className="text-sm font-medium text-brown-900 dark:text-brown-100 flex-1 truncate">
                        {event.title}
                      </span>
              ...
              {events.length > 0 && (
                <div className="mt-4 flex items-center gap-3">
                  <span className="text-[10px] uppercase tracking-wider text-brown-400 dark:text-brown-400 font-medium shrink-0">
                    Emotional Intensity
                  </span>
                  ...
                  <span className="text-sm font-semibold text-brown-700 dark:text-brown-200 shrink-0">
                    {avgImpact}/5
                  </span>
                </div>
              )}
        ...
        {isLoading ? (
          <div className="space-y-3">
            {[1, 2, 3, 4].map((i) => (
              <Card key={i} className="border-0 shadow-md bg-white dark:bg-white/5">
          ...
          <motion.div {...fadeInUp} transition={{ duration: 0.4, delay: 0.1 }}>
            <Card className="border-0 shadow-md bg-white dark:bg-white/5">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-brown-400 dark:text-brown-400">{error}</p>
                <Button
                  variant="outline"
                  size="sm"
            ...
            <AnimatePresence mode="popLayout">
              {events.map((event, index) => {
                ...
                return (
                  ...
                  >
                    <Card
                      className={`border-0 shadow-md bg-white dark:bg-white/5 overflow-hidden card-hover transition-all ${
                              ...
                              <div className="flex gap-3">
                                  ...
                                  <span
                                    className={`text-lg font-bold leading-tight ${
                                      today
                                        ...
                                        : 'text-brown-700 dark:text-brown-200'
                                    }`}
                                  >
                                    {day}
                                  </span>
                                  <span
                                    className={`text-[10px] uppercase tracking-wider ${
                                      today
                                        ...
                                        : 'text-brown-400 dark:text-brown-400'
                                    }`}
                                  >
                                    {monthAbbr}
                                  </span>
                                ...
                                <div className="flex-1 min-w-0">
                                  <div className="flex items-center gap-2 mb-1">
                                    ...
                                    <span
                                      className="text-sm font-semibold text-brown-900 dark:text-brown-100 truncate"
                                      style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
                                    >
                                      {event.title}
                                    </span>
                                  ...
                                  <div className="flex items-center gap-1.5">
                                    <span className="text-[10px] text-brown-400 dark:text-brown-400 shrink-0">
                                      Impact:
                                    </span>
                                  ...
                                  {/* Guidance text */}
                                  <p className="text-xs text-brown-500 dark:text-brown-300 mt-1.5 line-clamp-2">
                                    {event.guidance}
                                  </p>
                                </div>
                                ...
                                <div className="flex items-center self-center shrink-0">
                                  <ChevronDown
                                    className={`size-4 text-brown-300 dark:text-brown-400 transition-transform ${
                                      expanded ? 'rotate-180' : ''
                                    }`}
                                  />
                                </div>
                          ...
                          <div className="px-4 pb-4 pt-0">
                            <div className="ml-[68px] space-y-2 border-t border-brown-100 dark:border-brown-700/30 pt-3">
                              <div className="rounded-lg bg-brown-50 dark:bg-brown-800/20 p-3">
                                <p className="text-[10px] uppercase tracking-wider text-brown-400 dark:text-brown-400 mb-1">
                                  About This Event
                                </p>
                  ...
                  {upcomingEvents.map((event) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-medium text-brown-900 dark:text-brown-100 truncate">
                            {event.title}
                          </p>
