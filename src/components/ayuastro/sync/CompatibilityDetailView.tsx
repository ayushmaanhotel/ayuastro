  ...
  return (
    <div className="relative" style={{ width: size, height: size }}>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        <motion.span
          className="text-3xl font-bold text-brown-900 dark:text-brown-600"
      ...
      <div className="mx-auto max-w-lg space-y-6">
            ...
            <CardContent className="p-6">
              <div className="flex flex-col items-center">
                ...
                <div className="flex items-center gap-4 mb-4">
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-[10px] mt-1 font-medium text-brown-600 dark:text-brown-600">{userSunSign}</span>
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-[10px] mt-1 font-medium text-brown-600 dark:text-brown-600">{partnerSign}</span>
              ...
              <div className="grid grid-cols-3 gap-3 mt-6">
                <div className="text-center rounded-xl bg-brown-50 dark:bg-brown-50/20 p-3">
                  ...
                  <p className="font-serif text-lg font-bold text-brown-900 dark:text-brown-600">
                    {emotionalScore}%
                  </p>
            ...
            <CardContent>
              <div className="mb-3">
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className="text-sm font-semibold text-brown-900 dark:text-brown-600">{communication.score}%</span>
                </div>
            ...
            <CardContent>
              <div className="mb-3">
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className="text-sm font-semibold text-brown-900 dark:text-brown-600">{emotional.score}%</span>
                </div>
                <div className="h-2 rounded-full bg-brown-100 dark:bg-brown-50/20 overflow-hidden">
                  <motion.div
                    initial={{ width: 0 }}
        ...
        <motion.div {...fadeInUp} transition={{ duration: 0.4, delay: 0.4 }}>
          <Button
            onClick={() => setView('sync')}
            variant="outline"
            className="w-full border-brown-200 dark:border-brown-100/30 text-brown-600 dark:text-brown-500 hover:bg-brown-50 dark:hover:bg-brown-50/50"
          >
